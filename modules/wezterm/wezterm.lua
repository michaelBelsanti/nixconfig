...
return {
  ...
  keys = {
      ...
      { key = 'p', mods = 'SHIFT|ALT', action = act.PaneSelect{ alphabet =  '', mode =  'Activate' } },
      { key = 'r', mods = 'SHIFT|ALT', action = act.ReloadConfiguration },
      { key = 't', mods = 'SHIFT|ALT', action = act.SpawnTab 'CurrentPaneDomain' },
      { key = 'u', mods = 'SHIFT|ALT', action = act.CharSelect{ copy_on_select = true, copy_to =  'ClipboardAndPrimarySelection' } },
