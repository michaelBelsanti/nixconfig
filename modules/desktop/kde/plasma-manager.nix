{
  programs.plasma = {
    ...
    files = {
      ...
      "kwinrc"."Script-bismuth"."screenGapBottom" = 6;
      "kwinrc"."Script-bismuth"."screenGapLeft" = 6;
      "kwinrc"."Script-bismuth"."screenGapRight" = 6;
      "kwinrc"."Script-bismuth"."screenGapTop" = 6;
