{
  programs.plasma = {
    ...
    files = {
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{d13332d7-c9ea-4000-ba92-59f094fc0392}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{14e96189-40d8-450b-af4f-db0873cba971}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{671f7d20-67e2-4ed1-abba-16625fa83a5e}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{ac0aea9f-ba22-4dc0-8165-1da3e03cf1d9}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{22c70729-6a75-45d3-8cd6-7de15e879353}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{8d09c1f6-8db2-447d-b6dc-6741bf9268ca}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{94444bd0-d418-4670-a61a-238217ee839c}";
      ...
      "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."Image" = "/home/quasi/.flake/etc/bg.png";
      "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."PreviewImage" = "/home/quasi/.flake/etc/bg.png";
